<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $sql1 = "select pass, position from employee where firstname = '$user'";
            ...
            if($result1){
              ...
              if($record1['pass'] == $pass){
                  $_SESSION['userName'] = $user;
                  $_SESSION['position'] = $record1['position'];
  ...
  <div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-md-9 col-lg-6 col-xl-5">
        <img src="img/i.png"
          class="img-fluid" style="height:500px;" alt="Sample image">
      </div>
        ...
        <?php if(isset($error) ) {echo $error;} session_destroy();?>
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            ...
            <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account?<a href="#!"
                class="link-danger" data-bs-toggle="modal" data-bs-target="#empaddmodal"> Employee</a></p>
          </div>
